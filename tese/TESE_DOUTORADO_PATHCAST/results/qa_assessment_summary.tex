\begin{table}[htbp]
\centering
\caption{Quality-assessment results for the confirmed included set ($n = 169$; full QA applied). Scores were produced by the LLM-assisted QA protocol (Section~\ref{sec:slr-qa}).}
