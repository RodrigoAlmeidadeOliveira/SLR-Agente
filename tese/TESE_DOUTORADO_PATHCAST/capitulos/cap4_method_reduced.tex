...
stochastic layer and the most likely target of examination. Rather than
assuming it, PATHCAST submits it to a formal goodness-of-fit test per
repository and falls back to an explicit state augmentation when it is
rejected.
