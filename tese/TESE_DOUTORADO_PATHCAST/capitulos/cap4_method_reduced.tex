...
driver of process-model complexity and of the difficulty of conformance
checking and prediction, as discussed in trace-alignment
diagnostics~\cite{bose2013trace} and in large-scale discovery
benchmarks~\cite{augusto2019}.
