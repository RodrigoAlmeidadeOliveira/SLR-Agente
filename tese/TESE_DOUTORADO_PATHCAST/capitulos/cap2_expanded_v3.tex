...
Rubin et al.~\cite{rubin2014process} proposed the first explicit framework
for applying process mining to software development, identifying five
dimensions of analysis: process model extraction, performance measurement,
organizational mining, conformance checking, and decision mining. Their
framework mapped traditional process mining capabilities to the software
engineering domain, providing a conceptual bridge that subsequent research
could extend.
...
simulation~\cite{magennis2015forecasting, vacanti2020when}. Rather
...
by Sprint~12''). Magennis~\cite{magennis2015forecasting} demonstrated
...
Magennis~\cite{magennis2015forecasting} and
...
Rubin et al.~\cite{rubin2014process} proposed the first systematic
framework for applying process mining to software engineering, identifying
...
the intellectual scaffolding for subsequent research.
...
Thomason~\cite{WhittakerThomason1994} proposed the seminal application of
