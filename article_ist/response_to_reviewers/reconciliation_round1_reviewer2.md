...
| M14 | Zenodo público (R7 / SEGRESS 27) | **bloqueador** | **NEEDS-AUTHOR-DATA** | DOI no LaTeX: `10.5281/zenodo.20130276`; visibilidade Restricted só você confirma no site |
...
| m16 | Um único DOI Zenodo; alinhar 6.5 vs Data availability | média | **NOT-DONE** | Fonte atual usa só `20130276`; revisor viu também `15719919` (versão antiga?) |
